NDefines = {
	...
	NEconomy = {
		...
		MINIMUM_INTERESTS = 1.5,						-- _EDEF_MINIMUM_INTERESTS_
		BASE_INTERESTS = 5.0,							-- Base interests
	...
	NMilitary = {
		...
		ARMY_ATTRITION_AT_COAST = 0.5,					-- How many percent attrition units take while loaded onto ships along the coast
