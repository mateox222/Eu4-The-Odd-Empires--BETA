NDefines = {
	...
	NDiplomacy = {
		...
		IMPERIAL_REFORM_COST = 40,						-- Minium Cost of enacting a new reform.
		...
		NUM_OF_GREAT_POWERS = 11,						-- The number of ordinary (i.e. non-leaving) Great Powers if RightsOfManDLC is enabled.
	...
	NCountry = {
		...
		MINIMUM_ADVISOR_DURATION = 5, 					-- _CDEF_MINIMUM_ADVISOR_DURATION_
		...
		POWER_MAX = 1499,								-- how much power can be stored at maximum.
	...
	PS_BUY_EXPLORER = 25,
		...
		RELEASED_NATION_ARMY_SIZE = 0.25,				-- Newly released nations get an army of this size
		STARTING_ARMY_SIZE = 0.5,						-- Percentage of force limit
		STARTING_ARMY_SIZE_AT_WAR = 0.75,				-- Percentage of force limit
		...
		HIGH_LIBERTY_DESIRE = 60, 						-- Limit for when a subject starts getting rebellious from liberty desire (also used for alert)
		...
		MAX_LIBERTY_DESIRE = 125,						-- Max total (effective) liberty desire
	...
	NEconomy = {
		...
		GOLD_MINE_SIZE = 60,							-- Base income from gold mines
		...
		GOLD_INFLATION = 4.0,							-- _EDEF_GOLD_INFLATION_
		TREASURE_FLEET_INFLATION = 0.5,
		BASE_YEARLY_INFLATION = 0.25,					-- yearly inflation increase
		INFLATION_FROM_LOAN = 0.30,						-- increase per loan
		INFLATION_FROM_PEACE_GOLD = 0.1,				-- inflation per month of income taken in peace (also applied to province sales)
		INFLATION_ACTION_REDUCTION = 1.5,					-- amount per action
		BANKRUPTCY_DURATION = 2,						-- _EDEF_BANKRUPTCY_DURATION_
		...
		BASE_INTERESTS = 7.5,							-- Base interests
	...
	NMilitary = {
		...
		PARTICIPATION_SCORE_SIEGE = 0.02,				-- Per regiment engaged in sieges that are able to progress
		...
		ASSAULT_WIDTH_LIMIT = 3,						-- how many times the garrison size that can effectively assault at the same time.
		...
		CANNOT_RETREAT_DAYS = 6, 						-- How many days combat has to last before one side can retreat
		...
		MOTHBALLING_MONTHLY_DECREASE = 0.025,				-- When mothballin is turned on, the units strength will lose this much each month
	...
	NAI = {
		...
		ACCEPTABLE_FRACTION_OF_INTEREST_PAYMENTS = 0.2, --of income
		...
		ACCEPTABLE_BALANCE_DEFAULT = 1.0, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
		ACCEPTABLE_BALANCE_MULT_FRIEND_IN_COMBAT = 0.6,
		ACCEPTABLE_BALANCE_MULT_OFFENSIVE = 0.75, -- Unless friend in combat is already applied
		...
		DEFICIT_SPENDING_MIN_MONTHS = 12, -- AI must have at least this many monthly deficits of savings to be willing to deficit spend
		...
		MAX_SAVINGS = 48, -- AI will keep a maximum of this * their monthly income in long-term savings
		BUDGET_STEAL_THRESHOLD = 10.0, -- AI will move budget from one area to another if its priority is this many times as high.
		ADVISOR_BUDGET_FRACTION_MAX = 0.25, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
		...
		CONQUEST_INTEREST_DISTANCE = 50, -- Beyond this range, AI is less interested in conquest of provinces
		...
		PURSUE_DISTANCE = 200, -- AI will not pursue armies retreating to a province further away than this
		CALL_IN_ALLIES_POWER_RATIO = 2.5, -- AI will only call in allies in an offensive war if their military power ratio to the enemy is less than this
		...
		PEACE_CAPITAL_FACTOR = 10, -- AI unwillingness to peace based on holding their own capital
		...
		PEACE_TERMS_MIN_SCORE = 1.25, -- AI "does not want" peace treaties that get a lower score than this (modified by ai personality)
		...
		PEACE_TERMS_ANNEX_BASE_MULT = 120.0,
		PEACE_TERMS_PILLAGE_CAPITAL_MULT = 2.0,
		PEACE_TERMS_PROVINCE_BASE_MULT = 1.25,
		PEACE_TERMS_TRADE_POWER_BASE_MULT = 1.25,
		PEACE_TERMS_HUMILIATE_BASE_MULT = 1.25,
		PEACE_TERMS_REVOKE_CORES_BASE_MULT = 1.25,
		PEACE_TERMS_REVOKE_REFORM_BASE_MULT = 1.25,
		PEACE_TERMS_RETURN_CORES_BASE_MULT = 1.25,
		...
		MAX_ARMIES_NEW_REGION_ASSIGN_ALGORITHM = 10,				-- Max. amount of armies to use in new region assignment algorithm (fall back to old one)
		MAX_TASKS_NEW_REGION_ASSIGN_ALGORITHM = 60,				-- Max. amount of tasks to use in new region assignment algorithm (fall back to old one)
		...
		WAR_WARSCORE_TO_JOIN = -75,								-- Minimum warscore for the AI to join a call for arms
