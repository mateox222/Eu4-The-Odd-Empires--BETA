...
NDiplomacy = {
	...
	PEACE_COST_CONCEDE_PROVINCE = 0.5,				-- Demand colonial area province concession.
...
NCountry = {
	CLEAR_PROVINCE_VARIABLES_ON_CLEAR_OWNER = 0, 	--set to 0 to avoid clearing province variables when a province's owner is set to none (modder request)
	CLEAR_PROVINCE_FLAGS_ON_CLEAR_OWNER = 0,	 	--set to 0 to avoid clearing province flags when a province's owner is set to none (modder request)
	CLEAR_PROVINCE_SAVED_NAMES_ON_CLEAR_OWNER = 0, 	--set to 0 to avoid clearing province saved names when a province's owner is set to none (modder request)
	...
	ABDICATE_PRESTIGE_HIT = -15,


	DISINHERIT_PRESTIGE_HIT = -10,
	...
	REVOLUTION_DAILY_SPREAD = 0.5,			-- How much the revolution spreads each day (progress is 0-100)
...
NEconomy = {
	...
	GOLD_INFLATION = 1.5,							-- _EDEF_GOLD_INFLATION_
	TREASURE_FLEET_INFLATION = 0.5,
	BASE_YEARLY_INFLATION = 0.25,					-- yearly inflation increase
	INFLATION_FROM_LOAN = 2.0,						-- increase per loan
	INFLATION_FROM_PEACE_GOLD = 0.08,				-- inflation per month of income taken in peace (also applied to province sales)
...
NMilitary = {
	...
	ARMY_DRILL_YEARLY_DECAY = -0.5,					-- Loss from not Drilling
